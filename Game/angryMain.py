...
def GAME():
    ...
    welcome = interface.Label(420, 100, 400, 200, None, background)
    welcome.add_text("ANGRY BIRDS", 80, "Fonts/arfmoochikncheez.ttf", (236, 240, 241))

    start = interface.Button(300, 350, 300, 100, start_game, (244, 208, 63), (24, 220, 111))
    start.add_text("START GAME", 60, "Fonts/arfmoochikncheez.ttf", background)

    exit = interface.Button(700, 350, 300, 100, close, (241, 148, 138), (245, 183, 177))
