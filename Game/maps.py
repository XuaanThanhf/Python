...
class Maps:
    ...
    def draw_map(self):
        ...
        if self.level == 1:
            ...
            pigs.append(physics_engine.Pig(970, height - 40, 20))
            pigs.append(physics_engine.Pig(1300, height - 40, 20))

            blocks.append(physics_engine.Block(1150, height - 60, 60))
            ...
            blocks.append(physics_engine.Block(950, height - 60, 60))
            blocks.append(physics_engine.Block(950, height - 2*35, 60))
            ...
            pigs.append(physics_engine.Pig(1000, height - 60, 30))
            pigs.append(physics_engine.Pig(1100, height - 60, 30))

            blocks.append(physics_engine.Block(800, height - 100, 100))
            blocks.append(physics_engine.Block(800, height - 2*60, 100))
            blocks.append(physics_engine.Block(1300, height - 100, 100))
            blocks.append(physics_engine.Block(1300, height - 2*60, 100))
            ...
            pigs.append(physics_engine.Pig(1000, 500 - 60, 30))
            pigs.append(physics_engine.Pig(1100, height - 60, 30))

            walls.append(objects.Slab(800, 450, 500, 20))
            ...
            walls.append(objects.Slab(300, 400, 100, height - 400))
            walls.append(objects.Slab(800, 450, 500, 30))

            blocks.append(physics_engine.Block(950, 500 - 100, 100))
            blocks.append(physics_engine.Block(900, height - 100, 100))
            ...
            walls.append(objects.Slab(800, 0, 30, 450))
            walls.append(objects.Slab(800, 450, 500, 30))
            ...
            pigs.append(physics_engine.Pig(900, 500 - 60, 25))
            pigs.append(physics_engine.Pig(1100, 500 - 60, 25))
            pigs.append(physics_engine.Pig(1000, height - 60, 25))

            walls.append(objects.Slab(1000, 250, 30, 200))
            walls.append(objects.Slab(800, 450, 500, 30))
            ...
            walls.append(objects.Slab(500, 250, 30, height - 250))
            ...
            pigs.append(physics_engine.Pig(900, height - 60, 25))
            pigs.append(physics_engine.Pig(1250, height - 60, 25))


            blocks.append(physics_engine.Block(1050, height - 100, 100))
            blocks.append(physics_engine.Block(1050, height - 2*60, 100))

            walls.append(objects.Slab(500, 400, 30, height - 400))
            ...
            blocks.append(physics_engine.Block(1050, height - 100, 100))
            blocks.append(physics_engine.Block(1050, height - 2*60, 100))
            blocks.append(physics_engine.Block(700, height - 100, 100))

            walls.append(objects.Slab(700, 400, 500, 30))
            ...
            blocks.append(physics_engine.Block(700, height - 100, 100))
            blocks.append(physics_engine.Block(700, height - 2*60, 100))

            walls.append(objects.Slab(700, 400, 500, 40))
            walls.append(objects.Slab(1000, 500, 30, height - 500))
            ...
            pigs.append(physics_engine.Pig(900, height - 60, 25))
            pigs.append(physics_engine.Pig(900, 400 - 60, 25))
            pigs.append(physics_engine.Pig(1250, height - 60, 25))
            ...
            walls.append(objects.Slab(700, 400, 500, 40))
            walls.append(objects.Slab(700, 0, 30, 400))
            ...
            pigs.append(physics_engine.Pig(700, height - 60, 25))
            pigs.append(physics_engine.Pig(width - 600, 400 - 60, 25))
            pigs.append(physics_engine.Pig(1500, height - 60, 25))


            walls.append(objects.Slab(600, 400, 30, height - 400))
            walls.append(objects.Slab(800, 500, 30, height - 500))

            walls.append(objects.Slab(width - 700, 400, 500, 40))
            walls.append(objects.Slab(width - 700, 150, 60, 400 - 150))
    ...
    def level_cleared(self):
        ...
        level_cleared_text = interface.Label(500, 100, 400, 200, None, self.color['background'])
        ...
        score_text = interface.Label(550, 300, 300, 100, None, self.color['background'])
        score_text.add_text("SCORE: " + str(self.score), 55, "Fonts/Comic_Kings.ttf", (236, 240, 241))

        replay = interface.Button(150, 500, 300, 100, self.replay_level, (244, 208, 63), (247, 220, 111))
        replay.add_text("PLAY AGAIN", 60, "Fonts/arfmoochikncheez.ttf", self.color['background'])

        if self.level <= self.max_level:
            next = interface.Button(550, 500, 300, 100, self.draw_map, (88, 214, 141), (171, 235, 198))
            next.add_text("CONTINUE", 60, "Fonts/arfmoochikncheez.ttf", self.color['background'])
        else:
            next = interface.Button(550, 500, 300, 100, self.start_again, (88, 214, 141), (171, 235, 198))
            next.add_text("START AGAIN", 60, "Fonts/arfmoochikncheez.ttf", self.color['background'])

        exit = interface.Button(950, 500, 300, 100, close, (241, 148, 138), (245, 183, 177))
        exit.add_text("QUIT", 60, "Fonts/arfmoochikncheez.ttf", self.color['background'])
    ...
    def level_failed(self):
        level_failed_text = interface.Label(500, 100, 400, 200, None, self.color['background'])
        level_failed_text.add_text("LEVEL FAILED!", 80, "Fonts/Comic_Kings.ttf", (236, 240, 241))

        score_text = interface.Label(550, 300, 300, 100, None, self.color['background'])
        score_text.add_text("SCORE: " + str(self.score), 55, "Fonts/Comic_Kings.ttf", (236, 240, 241))

        replay = interface.Button(300, 480, 300, 100, self.draw_map, (244, 208, 63), (247, 220, 111))
        replay.add_text("TRY AGAIN", 60, "Fonts/arfmoochikncheez.ttf", self.color['background'])

        exit = interface.Button(750, 480, 300, 100, close, (241, 148, 138), (245, 183, 177))
        exit.add_text("QUIT", 60, "Fonts/arfmoochikncheez.ttf", self.color['background'])
    ...
    def start_level(self, birds, pigs, blocks, walls):
        ...
        slingshot = physics_engine.Slingshot(150, height - 200, 30, 200)
